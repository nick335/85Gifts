...
function Invoice() {
  ...
  return (
    <>
      <div
        ref={invoiceRef}
        className='w-[100%] h-[100%] pt-[15px] pl-[15px] pr-[10px] bg-gradient-to-br from-[#B5BCFF] via-[#E2E5FF] to-[#FFFFFF] '
      >
        <header className='flex item-center justify-between mb-5 lg:mx-8'>
          ...
          <div>
            <ul className='flex gap-5 item-center'>
              <li>
                <button className='hover:underline' onClick={handlePrint}>
                  Print
                </button>
              </li>
              <li>
        ...
        <main className='md:flex md:gap-2'>
          <div className='bg-white lg:max-w-3xl lg:mx-auto rounded shadow-2xl p-5 '>
            <div className='md:flex justify-between items-center mb-10'>
              <h2 className='text-start font-bold md:mb-0 mb-2'>
                Invoice ID: {invoiceData.invoiceNumber}
              </h2>
              <div>
                <p className='flex gap-10 mb-2'>
                  <span>Invoice Date:</span> <span>{currentDate}</span>
                </p>
                <p className='flex gap-10'>
                  <span>Due Date:</span> <span>{currentDate}</span>
                </p>
              </div>
            </div>
            <div className='md:flex mb-10'>
              <div className='recipient text-start'>
                <h3>
                  <b>Delivery to:</b>
                </h3>
                <p>Auscay Dev</p>
                <p>
                  3rd Flr, Alpha & Omega Elizabeth II Rd, Victoria Island,
                  Lagos.
                </p>
            ...
            <section>
              <h3 className='text-start text-xl font-bold mb-5'>
                Invoice Items
              </h3>
          ...
          <div className='bg-[#032bb7] text-white lg:max-w-3xl lg:mx-auto rounded shadow-2xl p-5 w-[100%] h-[55%] md:mt-0 mt-5'>
            <div className='flex justify-between'>
              ...
              <p className='text-xl font-bold text-start mb-5'>
                ₦{totalAmount.toLocaleString()}
              </p>
            </div>
            <hr></hr>
            <div className='mt-5'>
              <h2 className='text-start md:text-base text-sm'>
                Payment Method:
              </h2>
              <Select
                onValueChange={(value) =>
                  setPaymentMethod(value as 'Paystack' | 'Transfer')
                }
              >
