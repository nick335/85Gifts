  ...
  const orders = [
    {
      ...
      timeline: [
        { status: "Order Placed", date: "Aug 10", completed: true },
        ...
        <div className="bg-[#E8E5E5] p-4">
          <div className="flex justify-center items-center gap-4">
            <div className="flex items-center">
              ...
              <h2 className="text-sm md:text-lg font-semibold ml-2">Order History</h2>
            </div>
          </div>
        </div>
          ...
          {orders.map((order) => (
            <div key={order.id} className="flex flex-col md:flex-row gap-6">
              ...
              <div className="md:w-[40%] bg-[#E8E5E5] rounded-2xl p-5 h-fit">
                <h2 className="font-semibold text-xl md:text-2xl mb-6">Order Status</h2>
                  ...
                  {order.timeline.map((step, index) => (
                    <div key={index} className="mb-8 relative">
                      ...
                      {index < order.timeline.length - 1 && (
                        <div
                          className={`absolute left-[6px] top-[14px] w-0.5 h-full ${step.completed ? "bg-blue-600" : "bg-gray-200"
                            }`}
                        ></div>
                      )}
                      ...
                      <div className="flex items-start">
                        <div
                          className={`rounded-full h-3 w-3 mt-1.5 ${step.completed ? "bg-blue-600" : "bg-gray-200"
